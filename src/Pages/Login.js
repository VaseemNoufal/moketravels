...
export default function Login() {
    ...
    return (
        <Container>
            ...
            <RightContainer>
                <LoginContainer>
                    <LoginHeading>Login to your Account{username},{password}</LoginHeading>
                    <LoginInfo>Enter email and password to login</LoginInfo>
                    <Form onSubmit={handlesubmit}>
                        <InputContainer>
                            <TextInput value={username} onChange={(e) => setUsername(e.target.value)} type="email" placeholder="Email" />
                        </InputContainer>
                        <InputContainer>
